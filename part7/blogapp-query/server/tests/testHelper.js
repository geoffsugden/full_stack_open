...
const initialUsers = [
  { username: 'bbb66', name: 'Big Bird', password: 'testPassword' },
  { username: 'otg57', name: 'Oscar the Grouch', password: 'testPassword' },
  { username: 'gds48', name: 'Geoff Sugden', password: 'testPassword' },
]

const nonExistingId = async () => {
  const blog = new Blog({ title: 'willdeletesoon', author: 'alsodeletesoon', url: 'http://deleteme.delete', likes: 0 })
  await blog.save()
...
const getToken = async token => {
  ...
  return jwt.sign(userForToken, process.env.SECRET, { expiresIn: 30 })
}
module.exports = { initialBlogs, otherBlogs, initialUsers, nonExistingId, blogsInDb, usersInDb, getToken }
